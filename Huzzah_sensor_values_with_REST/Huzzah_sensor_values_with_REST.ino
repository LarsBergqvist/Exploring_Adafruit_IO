//
// This sketch uses an Adafruit Feather Huzzah for measuring
// temperature and humidity with a DHT11 sensor
// The values are sent as feeds to an Adafruit IO account via REST calls
//
...
Adafruit_IO_Feed temperatureFeed = aio.getFeed("garageTemperatures");
...
{  
  ...
  // Thus, connect D16 with the reset pin. After reset, setup will be executed again.
